...
import com.banksalad.collectmydata.referencebank.common.mapper.DepositAccountBasicHistoryMapper;
import com.banksalad.collectmydata.referencebank.common.mapper.DepositAccountBasicMapper;
...
public class DepositAccountBasicInfoResponseHelper implements AccountInfoResponseHelper<AccountSummary, DepositAccountBasic> {
  ...
  public void saveResponseCode(ExecutionContext executionContext, AccountSummary accountSummary, String responseCode) {
    accountSummaryService
        .updateBasicResponseCode(executionContext.getBanksaladUserId(), executionContext.getOrganizationId(), accountSummary,
            responseCode);
  }
}
