package com.banksalad.collectmydata.telecom.template.testcase;
...
public class TelecomBillTestCaseGenerator<GParent, Parent, Main, Child> {
    ...
    return List.of(
        TestCase.<GParent, Parent, Main, Child>builder()
            ...
            .requestParams(List.of(
                BareRequest.builder().chargeMonth(LAST_CHARGE_MONTH).build()
            ))
            .expectedResponses(List.of(
                BareResponse.builder().mockId("001_page_01").build()
            ))
        ...
        TestCase.<GParent, Parent, Main, Child>builder()
            ...
            .parentEntities(List.of(parentMap.get("parent1")))
            .mainEntities(List.of(mainMap.get("newMain")))
            .execution(execution)
            .requestParams(List.of(
                BareRequest.builder().chargeMonth(LAST_CHARGE_MONTH).build()
            ))
        ...
        TestCase.<GParent, Parent, Main, Child>builder()
            ...
            .expectedParentEntities(List.of(parentMap.get("touchedParent1")))
            .expectedMainEntities(List.of(mainMap.get("updatedNewMain")))
            .build()
    );
  }
}
