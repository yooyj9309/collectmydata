...
public class KafkaConsumerConfig {
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, String> telecomSyncRequestedKafkaListenerContainerFactory() {
    return kafkaListenerContainerFactory(MessageTopic.telecomSyncRequested);
  }

  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, String> telecomPublishmentRequestedKafkaListenerContainerFactory() {
    return kafkaListenerContainerFactory(MessageTopic.telecomPublishmentRequested);
  }
