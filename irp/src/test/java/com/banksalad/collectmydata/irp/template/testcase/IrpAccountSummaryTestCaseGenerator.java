...
public class IrpAccountSummaryTestCaseGenerator<GParent, Parent, Main, Child> {
    ...
    return List.of(
        TestCase.<GParent, Parent, Main, Child>builder()
            ...
            .expectedResponses(List.of(
                BareResponse.builder().mockId("001_page_00")
                    .status(HttpStatus.INTERNAL_SERVER_ERROR.value()).rspCode(RSP_CODE_SYSTEM_FAILURE).build()
            ))
        ...
        TestCase.<GParent, Parent, Main, Child>builder()
            ...
            .execution(execution)
            .requestParams(List.of(
                BareRequest.builder().searchTimestamp(ZERO_USS_ST).build()
            ))
            .expectedResponses(List.of(
