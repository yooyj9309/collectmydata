...
@Slf4j
public class CollectReactiveExecutorImpl implements CollectReactiveExecutor {
  ...
  public CollectReactiveExecutorImpl(
  ...
  @Override
  public <T, R> Flux<ExecutionResponse<R>> executeWithPagination(ExecutionContext context, Execution execution,
  ...
  private <T, R> Mono<ExecutionResponse<R>> exchange(ExecutionContext context, Execution execution,
      ExecutionRequest<T> executionRequest) {
    ...
    /* transfer */
    return transferClient.executeReactive(
