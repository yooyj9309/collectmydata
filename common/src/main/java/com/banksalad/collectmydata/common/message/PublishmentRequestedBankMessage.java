...
public class PublishmentRequestedBankMessage implements PublishmentRequestedMessage {
  ...
  public NotifyCollectmydatabankSyncedRequest toNotifyRequest() {
    ...
    switch (financeSyncItem) {
      case COLLECTMYDATABANK_SYNC_ITEM_DEPOSIT_ACCOUNT_TRANSACTION:
      case COLLECTMYDATABANK_SYNC_ITEM_INVEST_ACCOUNT_TRANSACTION:
      case COLLECTMYDATABANK_SYNC_ITEM_LOAN_ACCOUNT_TRANSACTION:
        return NotifyCollectmydatabankSyncedRequest.newBuilder()
            ...
            .setTransactionSyncCondition(BankAccountTransactionSyncCondition.newBuilder()
  ...
  public CollectmydatabankSyncItem convertFinanceSyncItemToProtoEnum(FinanceSyncItem financeSyncItem) {
    switch (financeSyncItem) {
      ...
      case COLLECTMYDATABANK_SYNC_ITEM_INVEST_ACCOUNT_BASIC:
        return CollectmydatabankSyncItem.COLLECTMYDATABANK_SYNC_ITEM_INVEST_ACCOUNT_BASIC;

      case COLLECTMYDATABANK_SYNC_ITEM_INVEST_ACCOUNT_DETAIL:
      ...
      case COLLECTMYDATABANK_SYNC_ITEM_LOAN_ACCOUNT_BASIC:
        return CollectmydatabankSyncItem.COLLECTMYDATABANK_SYNC_ITEM_LOAN_ACCOUNT_BASIC;

      case COLLECTMYDATABANK_SYNC_ITEM_LOAN_ACCOUNT_DETAIL:
      ...
      case COLLECTMYDATABANK_SYNC_ITEM_COMPLETED:
