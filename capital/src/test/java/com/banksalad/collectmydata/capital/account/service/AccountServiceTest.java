package com.banksalad.collectmydata.capital.account.service;
...
public class AccountServiceTest {
  ...
  public void updateAccountTimestamp_success() {
    ...
    accountService.updateSearchTimestampForAccount(banksaladUserId, organizationId, accountAssembler());
  ...
  public void updateAccountTimestamp_invalid_account() {
    ...
    Exception exception = assertThrows(
        Exception.class,
        () -> accountService.updateSearchTimestampForAccount(banksaladUserId, organizationId, null)
    );
