...
@Component
public class LoanAccountDetailPublishmentHelper implements AccountInfoPublishmentHelper {

  private static final FinanceIndustry financeIndustry = FinanceIndustry.BANK;
  private static final FinanceSyncItem financeSyncItem = FinanceSyncItem.COLLECTMYDATA_BANK_SYNC_ITEM_LOAN_ACCOUNT_DETAIL;
