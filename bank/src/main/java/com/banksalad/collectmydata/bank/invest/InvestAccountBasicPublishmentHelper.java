...
@Component
public class InvestAccountBasicPublishmentHelper implements AccountInfoPublishmentHelper {

  private static final FinanceIndustry financeIndustry = FinanceIndustry.BANK;
  private static final FinanceSyncItem financeSyncItem = FinanceSyncItem.COLLECTMYDATA_BANK_SYNC_ITEM_INVEST_ACCOUNT_BASIC;
