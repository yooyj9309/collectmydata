package com.banksalad.collectmydata.bank.template.testcase;
...
public class InvestAccountTransactionTestCaseGenerator<GParent, Parent, Main, Child> {
    ...
    return List.of(
        ...
        TestCase.<GParent, Parent, Main, Child>builder()
            ...
            .expectedResponses(List.of(
                ...
                BareResponse.builder().mockId("002_page_02").status(STATUS_FORBIDDEN)
