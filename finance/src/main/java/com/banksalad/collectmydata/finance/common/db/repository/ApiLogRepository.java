...
public interface ApiLogRepository extends JpaRepository<ApiLogEntity, Long> {
  ...
  Optional<ApiLogEntity> findByConsentIdAndSyncRequestIdAndExecutionRequestIdAndApiRequestIdAndCreatedAtBetween(
      String consentId, String syncRequestId, String executionRequestId, String apiRequestId, LocalDateTime minusDays,
