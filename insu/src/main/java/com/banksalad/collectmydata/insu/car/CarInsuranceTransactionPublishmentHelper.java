...
@Component
public class CarInsuranceTransactionPublishmentHelper implements TransactionPublishmentHelper<InsuranceSummary> {
  ...
  public PublishmentRequestedMessage makePublishmentRequestedMessage(ExecutionContext executionContext,
    ...
    return PublishmentRequestedInsuMessage.builder()
        ...
        .financeSyncItem(FinanceSyncItem.COLLECTMYDATAINSU_SYNC_ITEM_CAR_INSURANCE_TRANSACTION)
