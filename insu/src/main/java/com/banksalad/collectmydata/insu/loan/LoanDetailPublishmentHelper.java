...
@Component
public class LoanDetailPublishmentHelper implements AccountInfoPublishmentHelper {
  ...
  public PublishmentRequestedMessage makePublishmentRequestedMessage(ExecutionContext executionContext) {
    return PublishmentRequestedInsuMessage.builder()
        ...
        .financeSyncItem(FinanceSyncItem.COLLECTMYDATAINSU_SYNC_ITEM_LOAN_DETAIL)
