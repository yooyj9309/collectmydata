...
@Component
public class InsuranceContractPublishmentHelper implements AccountInfoPublishmentHelper {
  ...
  public PublishmentRequestedMessage makePublishmentRequestedMessage(ExecutionContext executionContext) {
    return PublishmentRequestedInsuMessage.builder()
        ...
        .financeSyncItem(FinanceSyncItem.COLLECTMYDATAINSU_SYNC_ITEM_INSURANCE_CONTRACT)
