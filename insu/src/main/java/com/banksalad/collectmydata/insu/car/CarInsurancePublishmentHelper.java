...
@Component
public class CarInsurancePublishmentHelper implements AccountInfoPublishmentHelper {
  ...
  public PublishmentRequestedMessage makePublishmentRequestedMessage(ExecutionContext executionContext) {
    return PublishmentRequestedInsuMessage.builder()
        ...
        .financeSyncItem(FinanceSyncItem.COLLECTMYDATAINSU_SYNC_ITEM_CAR_INSURANCE)
