...
public class KafkaConsumerConfig {
  ...
  public ConcurrentKafkaListenerContainerFactory<String, String> insuSyncRequestedKafkaListenerContainerFactory() {
    return kafkaListenerContainerFactory(MessageTopic.insuSyncRequested);
  }

  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, String> insuPublishmentRequestedKafkaListenerContainerFactory() {
    return kafkaListenerContainerFactory(MessageTopic.insuPublishmentRequested);
  }
