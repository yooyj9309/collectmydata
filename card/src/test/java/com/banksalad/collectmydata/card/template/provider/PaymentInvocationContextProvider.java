...
import com.banksalad.collectmydata.card.template.testcase.PaymentTestCaseGenerator;
...
public class PaymentInvocationContextProvider implements TestTemplateInvocationContextProvider {

  private static final Execution execution = Executions.finance_card_payment;
  ...
  public Stream<TestTemplateInvocationContext> provideTestTemplateInvocationContexts(ExtensionContext context) {
    ...
    PaymentEntity main1 = PaymentEntity.builder()
        .syncedAt(OLD_SYNCED_AT)
        .banksaladUserId(BANKSALAD_USER_ID)
        .organizationId(ORGANIZATION_ID)
        .payDueDate("202104010")
        .payAmt(bigDecimalOf(100000, 3))
        .build();
    Map<String, PaymentEntity> mainMap = Map.of(
        "main1", main1
    );

    PaymentTestCaseGenerator<Object, UserSyncStatusEntity, PaymentEntity, Object> generator = new PaymentTestCaseGenerator<>(
  ...
  private TestTemplateInvocationContext invocationContext(
      TestCase<Object, UserSyncStatusEntity, PaymentEntity, Object> testCase) {
