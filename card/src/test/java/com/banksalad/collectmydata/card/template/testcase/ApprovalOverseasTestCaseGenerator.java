...
import static com.banksalad.collectmydata.finance.test.constant.FinanceTestConstants.NEXT_PAGE;
...
public class ApprovalOverseasTestCaseGenerator<GParent, Parent, Main, Child> {
  ...
  public List<TestCase<GParent, Parent, Main, Child>> generate() {
    ...
    return List.of(
        ...
        TestCase.<GParent, Parent, Main, Child>builder()
            ...
            .requestParams(List.of(
                BareRequest.builder().nextPage(null).build(),
                BareRequest.builder().nextPage(NEXT_PAGE).build()
            ))
            .expectedResponses(List.of(
