...
import com.banksalad.collectmydata.card.template.testcase.RevolvingTestCaseGenerator;
...
public class RevolvingInvocationContextProvider implements TestTemplateInvocationContextProvider {

  private static final Execution execution = Executions.finance_loan_revolvings;
  ...
  public Stream<TestTemplateInvocationContext> provideTestTemplateInvocationContexts(ExtensionContext context) {
    ...
    RevolvingEntity main1 = RevolvingEntity.builder()
        .syncedAt(OLD_SYNCED_AT)
        .banksaladUserId(BANKSALAD_USER_ID)
        .organizationId(ORGANIZATION_ID)
        .revolvingMonth(202104)
        .reqDate("20210301")
        .minPayAmt(bigDecimalOf(100_000, 3))
        .minPayRate(bigDecimalOf(5, 3))
        .agreedPayRate(bigDecimalOf(5, 3))
        .remainedAmt(bigDecimalOf(80_000, 3))
        .revolvingNo((short) 1)
        .build();
    Map<String, RevolvingEntity> mainMap = Map.of(
        "main1", main1
    );

    RevolvingTestCaseGenerator<Object, UserSyncStatusEntity, RevolvingEntity, Object> generator = new RevolvingTestCaseGenerator<>(
  ...
  private TestTemplateInvocationContext invocationContext(
      TestCase<Object, UserSyncStatusEntity, RevolvingEntity, Object> testCase
  ) {
