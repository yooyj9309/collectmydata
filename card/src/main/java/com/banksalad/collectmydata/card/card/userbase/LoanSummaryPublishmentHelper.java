...
@Component
public class LoanSummaryPublishmentHelper implements UserbasePublishmentHelper {

  private static final FinanceIndustry financeIndutry = FinanceIndustry.CARD;
  private static final FinanceSyncItem financeSyncItem = FinanceSyncItem.COLLECTMYDATACARD_SYNC_ITEM_LOAN_SUMMARY;
  ...
  public PublishmentRequestedMessage makePublishmentRequestedMessage(ExecutionContext executionContext) {
    return PublishmentRequestedCardMessage.builder()
        .financeIndustry(financeIndutry)
