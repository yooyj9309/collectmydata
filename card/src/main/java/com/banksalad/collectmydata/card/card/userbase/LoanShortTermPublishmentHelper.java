...
@Component
public class LoanShortTermPublishmentHelper implements UserbasePublishmentHelper {

  private static final FinanceIndustry financeIndustry = FinanceIndustry.CARD;
  private static final FinanceSyncItem financeSyncItem = FinanceSyncItem.COLLECTMYDATACARD_SYNC_ITEM_LOAN_SHORT_TERM;
