...
@Component
public class ApprovalDomesticPublishmentHelper implements TransactionPublishmentHelper<CardSummary> {

  private static final FinanceIndustry financeIndustry = FinanceIndustry.CARD;
  private static final FinanceSyncItem financeSyncItem = FinanceSyncItem.COLLECTMYDATACARD_SYNC_ITEM_CARD_APPROVAL_DOMESTIC_TRANSACTION;
